...
begin
  ...
  try
    ...
    begin
      ...
      if Names.Count > 1 then // two or more file with same size
      begin
        ...
        begin
          ...
          try
            FileInfo.Hash := THashSHA2.GetHashStringFromFile(Dir + '\' + FileInfo.Filename);
          except
    ...
    for Names in TempFiles.Values do Names.Free;
    TempFiles.Free;
  end;
end;
